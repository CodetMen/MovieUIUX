...
public class CardViewNowplayingAdapter extends RecyclerView.Adapter<CardViewNowplayingAdapter.CardViewViewHolder>{

    private ArrayList<Movie> listMovie;
    private Context context;

    public CardViewNowplayingAdapter(Context context) {
